# adsorption
A python package for estimating the best isotherm models (i.e., Langmuir, Freundlich, Temkin, Toth, Sips, DR), the best kinetic models (i.e., PFO, PSO, Weber-Morris, Avrami, Bangham, Elovich) and Arrhenius parameters (i.e., Ea, A), the best adsorption dynamic models (i.e., Thomas, Yoon-Nelson, Adams-Bohart), and adsorption enthalpy and entropy.

[Install](#Install) / [Usage](#Usage) /  [Isotherms](#Isotherms) / [Kinetics](#Kinetics) / [Arrhenius](#Arrhenius) / [AdsorptionDynamics](#AdsorptionDynamics) / [References](#References)
