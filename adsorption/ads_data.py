...
df_kin = pd.read_csv('Python/adsorption_kinetics.csv')
...
df_dyn = pd.read_csv('Python/Co_10%.csv')
...
df_iheat1 = pd.read_csv('Python/iso_heat1.csv')
x_iheat1 = df_iheat1.loc[:, 'x'].values
y_iheat1 = df_iheat1.loc[:, 'y'].values

df_iheat2 = pd.read_csv('Python/iso_heat2.csv')
